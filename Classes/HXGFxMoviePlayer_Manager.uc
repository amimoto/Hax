class HXGFxMoviePlayer_Manager extends KFGfxMoviePlayer_Manager;
...
defaultproperties
{
    ...
    WidgetBindings.Add((WidgetName="PerksMenu",WidgetClass=class'HXGFxMenu_Perks'))
    WidgetBindings.Remove((WidgetName="traderMenu",WidgetClass=class'KFGFxMenu_Trader'))
    WidgetBindings.Add((WidgetName="traderMenu",WidgetClass=class'HXGFxMenu_Trader'))
